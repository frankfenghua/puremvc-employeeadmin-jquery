...
if( typeof HidePureMVC == "undefined" )
	Observer = Objs.get("puremvc.Observer");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	Notification = Objs.get("puremvc.Notification");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
new function()
{
	var Observer = Objs.get("puremvc.Observer");
...
{
	var Observer = Objs.get("puremvc.Observer");
	var View = Objs.get("puremvc.View");
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	Controller = Objs.get("puremvc.Controller");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
new function()
{
	var Model = Objs.get("puremvc.Model");
	var View = Objs.get("puremvc.View");
	var Controller = Objs.get("puremvc.Controller");
	var Notification = Objs.get("puremvc.Notification");
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	Facade = Objs.get("puremvc.Facade");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
new function()
{
	var Facade = Objs.get("puremvc.Facade");
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	Notifier = Objs.get("puremvc.Notifier");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	SimpleCommand = Objs.get("puremvc.SimpleCommand");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	MacroCommand = Objs.get("puremvc.MacroCommand");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
...
//Offer a way to hide PureMVC from the global context.
if( typeof HidePureMVC == "undefined" )
	Mediator = Objs.get("puremvc.Mediator");
/*
 PureMVC Javascript for Objs port by Frederic Saunier <frederic.saunier@puremvc.org>
 PureMVC - Copyright(c) 2006-2011 Futurescale, Inc., Some rights reserved.
 Your reuse is governed by the Creative Commons Attribution 3.0 License
